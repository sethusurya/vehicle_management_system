...
SELECT * FROM USERS;
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_PHONE_NO('rowen@yahoo.com', '9425400067');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_FIRST_NAME('sethu@gmail.com','Seth');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_USER_NAME('shubham@gmail.com','Shubham');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_LAST_NAME('raj@gmail.com','');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_BLACKLISTED('shahrukh@gmail.com','');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_PASSWORD('sethu@gmail.com','');
EXECUTE PCKG_USERS_UPDATE.UPDATE_USERS_DRIVER_LICENSE('noordeep@gmail.com','1234567895');